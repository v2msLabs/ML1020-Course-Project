...
The model training was done using 50 epochs, with the batch size of 256 and validation set of 25% of the training dataset. For illustration purposes we present the model training graph.
